...
in the document records that anything was meant at all. In a document you
...
\cs{AltJdgTuck} to \texttt{0pt} for the untucked layout. A stack in which no alternative
...
\textbackslash Next, \textbackslash NNext, \textbackslash Last, \textbackslash LLast & Relative references; \oarg{letter} adds a sub-example part, as (3b). \\
